...
import { ASCIIIcon, SkillConstellation } from '../components/ASCII/CareerASCII'
import { ASCIIButton } from '../components/ASCII/InteractiveASCII'
      ...
      <section className="relative bg-gradient-to-br from-brand-50 via-primary-50 to-secondary-50 py-20 overflow-hidden">
        <div className="absolute inset-0">
          <ASCIIRenderer
            ...
            theme="light"
            interactive={true}
            className="opacity-10 h-full w-full"
          />
        </div>
        ...
        <div className="container-content relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <ASCIIButton 
                onClick={() => window.location.href = '/job-analysis'}
                className="btn-brand text-lg px-8 py-4 shadow-lg"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="feature-card animate-scale-in group relative"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div className="absolute top-2 right-2 opacity-20">
                    <ASCIIIcon type="skill" size="sm" />
                  </div>
